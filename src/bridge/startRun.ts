...
import { getModeById, ModeId } from '../modes/GameModeConfig';
...
export interface StartRunConfig {
  modeId:  ModeId;
  classId: string;   // empty string = random (used when forceRandomClass)
}
 ...
 */
export function startRun(config: StartRunConfig): void {

import { ALL_MILESTONES, PROFILE_SCHEMA_VERSION, } from '../types';
...
export class LocalProfileService {
    ...
    recordRunEnd(run) {
        ...
        newTitles.forEach(id => {
            if (!p.unlocked_titles.includes(id))
                p.unlocked_titles.push(id);
        });

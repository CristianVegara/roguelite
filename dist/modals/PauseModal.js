...
export class PauseModal {
    ...
    open() {
        ...
        panel.append(this.buildTitle(), this.buildButtons());
    ...
    close() {
        ...
        const dim = this.root.querySelector('.pause-panel')?.closest('.modal-dim');
        if (dim) {
            if (dim._onKey)
                document.removeEventListener('keydown', dim._onKey);

...
const _threshold_cache = [];
function xpForLevel(level) {
    if (_threshold_cache[level] !== undefined)
        return _threshold_cache[level];
...
export class XPManager {
    constructor() {
        ...
        this.nextThreshold = xpForLevel(1); // XP required to reach level 1
    }
    get currentLevel() { return this.level; }
    get currentXP() { return this.xp; }
    get xpToNextLevel() {

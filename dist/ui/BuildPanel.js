...
export class BuildPanel {
    constructor(scene, owned, relics) {
        this.visible = false;
        this.PANEL_W = 200;
        this.PANEL_X = GAME_WIDTH - 200 - 4; // 276
        this.PANEL_Y = 50;
        this.MAX_H = GAME_HEIGHT - 80;
        this.LINE_H = 15;
        // Scrolling
        this.scrollOffset = 0;
    ...
    rebuild() {
        ...
        maskG.fillRect(this.PANEL_X, this.PANEL_Y + 24, this.PANEL_W, panelH - 28);
        ...
        if (ownedEntries.length === 0) {
            contentContainer.add(this.scene.add.text(8, y, 'none yet', {
        ...
        if (relicEntries.length === 0) {
            ...
            for (const id of relicEntries) {
                ...
                contentContainer.add(this.scene.add.text(8, y, `◈ ${name}`, {

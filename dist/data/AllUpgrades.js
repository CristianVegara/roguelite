...
function rarityWeightsForFloor(floor) {
    ...
    if (floor <= 6)
        return { common: 60, uncommon: 28, rare: 10, legendary: 2 };
    if (floor <= 10)
        return { common: 40, uncommon: 30, rare: 22, legendary: 8 };
    if (floor <= 15)
        return { common: 20, uncommon: 30, rare: 32, legendary: 18 };
 ...
 */
export function pickRunUpgrades(count, floor, owned, classWeights) {

...
export class ClassScene extends Phaser.Scene {
    constructor() {
        ...
        this.sbDragOffset = 0; // ptr.y − thumb top edge at drag start
    }
    create() {
        this.scrollY = 0;
        this.sbDragging = false;
    ...
    drawHeader() {
        ...
        const backBtn = this.add.text(12, 30, '← BACK', {
            ...
            .on('pointerdown', () => this.cameras.main.fadeOut(180, 0, 0, 0, (_, p) => {
            if (p === 1)
        ...
        this.input.keyboard?.once('keydown-ESC', () => {
            this.cameras.main.fadeOut(180, 0, 0, 0, (_, p) => {
                if (p === 1)
                    this.scene.start('HomeScene');
            });
        });

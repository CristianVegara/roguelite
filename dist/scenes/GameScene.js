...
export class GameScene extends Phaser.Scene {
    constructor() {
        ...
        this.preRunUpgradePicksRemaining = 0;
        this.currentClass = null;
        this.runStartTime = 0;
        this.currentEnemyName = 'ENEMY';
        this.busOffSpeed = null;
        this.busOffPause = null;
        this.busOffRestart = null;
        this.busOffQuit = null;
        this.gameSpeed = 1;
        this.hitCounterLabel = null;
    }
    create() {
        this.state = 'fighting';
        ...
        this.busOffRestart = bus.on('pause:restart', () => {
            ...
            this.scene.resume();
            startRun({ modeId: cfg.modeId, classId: cfg.classId });
        });
    ...
    launchUpgradeScreen(afterChoiceCallback, forcedContextLabel) {
        ...
        const primaryCategory = classWeights
    ...
    clampPlayerSprite() {
        ...
        const candidates = [this.player, this.player.sprite];
    ...
    updateModifierLabel() { this.syncRunState(); }
    updateRelicHud() { this.syncRunState(); }
...
GameScene.SUMMON_UPGRADE_IDS = new Set([

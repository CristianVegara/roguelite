...
import { getClassSkins } from '../data/ClassSkins';
...
class ShopScreen {
    constructor() {
        this.selectedClass = ALL_CLASSES[0];
        this.selectedChoice = { kind: 'base', classId: ALL_CLASSES[0]?.id ?? '' };
        this.el = this.build();
    ...
    renderClassButtons() {
        this.classListEl.querySelectorAll('.shop-class-btn').forEach((btn) => {

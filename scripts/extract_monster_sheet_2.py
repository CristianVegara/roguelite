#!/usr/bin/env python3
"""Extracts monster_spreadsheet.png into engine-ready monster cells.

The extraction uses explicit coordinates per loop iteration to prevent cumulative
coordinate drift and produce stable width/height, center, and bounding box data.
"""
...
# -------------------------
IMAGE_PATH = Path('src/assets/sprites/monster_spreadsheet.png')
OUTPUT_SUBDIR = 'monster_sheet_2_cells'
FILE_PREFIX = 'monster_2'
TOTAL_ROWS = 9
TOTAL_COLS = 10
CELL_WIDTH = 125
CELL_HEIGHT = 89
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Extract monster_spreadsheet.png into engine-ready grid cells with exact coordinates.'
    )
